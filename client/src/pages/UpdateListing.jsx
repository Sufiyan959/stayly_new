    ...
    if (files.length > 0 && files.length + formData.imageUrls.length <= 6) {
      ...
      try {
        ...
        setFormData((prevFormData) => ({
          ...prevFormData,
          imageUrls: [...prevFormData.imageUrls, ...imageUrls],
        }));
        setImageUploadError(false);
        setUploading(false);
        setFiles([]);
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 py-8 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-6 text-center">
          <h1 className="text-3xl font-bold text-white">Update Listing</h1>
          <p className="text-slate-300 text-sm mt-1">Edit your property details</p>
        </div>
          ...
          {activeTab === 'images' && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-500 mb-2">First image will be the cover ({formData.imageUrls.length}/6)</p>
              ...
              {formData.imageUrls.length > 0 && (
                <div>
                  <p className="text-sm font-semibold text-slate-700 mb-2">Your Images ({formData.imageUrls.length}/6)</p>
